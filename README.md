...
- **Pywal-aware styling** — colours pulled from your wallpaper theme
...
- **Loading spinner** — animated indicator during refresh
...
```bash
git clone git@github.com:z89/signal.git ~/Documents/Github-Projects/ycombo
...
| File | Purpose |
|---|---|
| `ycombo.py` | Fetches & filters HN posts via Algolia API, writes `/tmp/ycombo_cache.json` |
